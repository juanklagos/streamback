	            								...
	            								<li class="dropup">
									                ...
									                <ul class="dropdown-menu dropdown-menu-right">
									                  	<li role="presentation">
										                  	...
										                  	@else
									                  			<a role="menuitem" tabindex="-1" onclick="return confirm('Are you sure?')" href="{{route('admin.delete.video' , ['admin_video_id' => $video->video_id] )}}">{{tr('delete')}}</a>
									                  		@endif
									                  	</li>
									                	...
									                	@else
									                  	...
									                  	<li role="presentation"><a role="menuitem" tabindex="-1" href="{{route('admin.spam-videos.user-reports' , ['admin_video_id' => $video->video_id] )}}">{{tr('user_reports')}}</a></li>
									                </ul>
	              								</li>
	            							</ul>
								      </td>

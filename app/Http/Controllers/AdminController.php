...
use App\Language, App\Notification, App\EmailTemplate, App\Settings, App\Page, App\Flag;
...
class AdminController extends Controller
{
    ...
    public function users_status_change(Request $request) {
        ...
        try {
            ...
            $user_details->is_activated = $user_details->status;

            $message = $user_details->status == USER_ACTIVATED ? tr('admin_user_activate_success') : tr('admin_user_deactivate_success');
    ...
    public function subscriptions_index() {
        ...
        $subscriptions = Subscription::orderBy('id','desc')->whereNotIn('status', [DELETE_STATUS])->paginate(10);
    ...
    public function admin_videos_index(Request $request) {
        ...
        if($request->search_key) {
            ...
            $base_query = $base_query
                    ...
                    ->orWhere('sub_categories.name','LIKE','%'.$request->search_key.'%');
        }
